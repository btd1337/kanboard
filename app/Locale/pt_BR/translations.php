...
return array(
    ...
    'Assign the task to a specific user' => 'Atribuir a tarefa para um usuário específico',
    'Assign the task to the person who does the action' => 'Atribuir a tarefa para a pessoa que executa a ação',
    ...
    'Assign a color to a specific user' => 'Atribuir uma cor para um usuário específico',
    'Position' => 'Posição',
    ...
    'I only want to receive notifications for these projects:' => 'Quero receber notificações apenas destes projetos:',
    ...
    'Assign a color when the task is moved to a specific column' => 'Atribuir uma cor quando a tarefa for movida para uma coluna específica',
    ...
    'There is no user management for personal projects.' => 'Não há gerenciamento de usuários para projetos pessoais.',
    ...
    'This chart shows the average time spent in each column for the last %d tasks.' => 'Este gráfico mostra o tempo médio gasto em cada coluna para as %d últimas tarefas.',
    ...
    'This chart shows the average lead and cycle time for the last %d tasks over the time.' => 'Este gráfico mostra o tempo médio do tempo de condução e tempo de ciclo das últimas %d tarefas.',
    ...
    'Project owner' => 'Líder do projeto',
    'Personal projects do not have users and groups management.' => 'Projetos pessoais não têm gestão de usuários e grupos.',
    ...
    'Close a task when there is no activity in a specific column' => 'Fechar a tarefa quando não houver atividade numa coluna especifica',
    ...
    'A new internal link for the task #%d has been defined' => 'Uma nova ligação para a tarefa #%d foi definida',
    ...
    '%d task' => '%d tarefa',
    'Task ID' => 'ID da tarefa',
    'Assign automatically a color when due date is expired' => 'Atribuir automaticamente uma cor quando a data de vencimento está expirada',
    ...
    'Column task limits are applied to each swimlane individually' => 'Limites de tarefas da coluna estão aplicados a cada raia individualmente',
    'Column task limits are applied across swimlanes' => 'Limites de tarefas da coluna estão aplicados por todas as raias',
    'Task limit: ' => 'Limite de tarefas:',
    ...
    'Group membership(s):' => 'Filiação a grupo(s):',
    '%s is a member of the following group(s): %s' => '%s é um membro do(s) seguinte(s) grupo(s): %s',
    '%d/%d group(s) shown' => '%d/%d grupo(s) exibidos',
    'Subtask creation or modification' => 'Criação ou edição de subtarefas',
    'Assign the task to a specific user when the task is moved to a specific swimlane' => 'Atribuir a tarefa a um usuário específico quando a tarefa for movida para uma raia especifica',
    'Comment' => 'Comentário',
